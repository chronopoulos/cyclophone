 ...
 * this function.
 * *********************************************************/
int spidevice::spiOpen(std::string devspi){
    int statusVal = -1;
 ...
 * ***********************************************/
spidevice::spidevice(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord){
    this->mode = spiMode ;
